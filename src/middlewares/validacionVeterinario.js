...
export const validacionVeterinario = [
  check(["nombre", "apellido", "direccion", "telefono", "email", "password"])
    .exists()
    .withMessage(
      'Los campos "nombre" "apellido" "dirección" "teléfono" "email" y/o "password" son obligatorios'
    )
    .notEmpty()
    .withMessage(
      'Los campos "nombre" "apellido" "dirección" "teléfono" "email" y/o "password" no pueden estar vacíos'
    )
